...
const getTimeDifferenceInMinutes = (a, b = null) => (getTimeDifferenceInMilliseconds(a, b) / 60000).toFixed(2);

const getTimeDifferenceInHours = (a, b = null) => (getTimeDifferenceInMilliseconds(a, b) / 3600000).toFixed(2);

const getTimeDifferenceInDays = (a, b = null) => (getTimeDifferenceInMilliseconds(a, b) / (24 * 3600 * 1000)).toFixed(2);

const getTimeDifferenceInWeeks = (a, b = null) => (getTimeDifferenceInMilliseconds(a, b) / (24 * 3600 * 1000 * 7)).toFixed(2);

const getTimeDifferenceInMonths = (a, b = null) => ((b.getMonth() + 12 * b.getFullYear()) - (a.getMonth() + 12 * a.getFullYear())).toFixed(2);
...
const getTimeDifferenceForHumans = (a, b = null) => {
  ...
  if (s < 60)
    return s < 30 ? 'seconds' : `${s} ${plural('second', s)}`;
