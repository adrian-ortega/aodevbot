...
const getTimeDifferenceInSeconds = (a, b = null) =>
  getTimeDifferenceInMilliseconds(a, b) / 1000;
...
const getTimeDifferenceInMonths = (a, b = null) =>
  (
    b.getMonth() +
    12 * b.getFullYear() -
    (a.getMonth() + 12 * a.getFullYear())
  ).toFixed(2);

const getTimeDifferenceInYears = (a, b = null) =>
  (b.getFullYear() - a.getFullYear()).toFixed(2);
