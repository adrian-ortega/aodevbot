...
const { getTimeDifferenceForHumans, getTimeDifferenceInDays, getTimeDifferenceInHours } = require('../../../support/time');
...
exports.name = 'lurk';
exports.description = 'Will keep track of timestamps when chatters go on !lurk.';
...
exports.handle = async (message, state, channel, { client }, resolve) => {
  ...
  if (!saved._options.isNewRecord) {
    return client.say(channel, botMessageReply(
